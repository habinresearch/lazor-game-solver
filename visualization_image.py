...
>>>>>>> bbc42e4e2541b64d69ed58dfb580187f45faa233
        x += vx
        y += vy
...
<<<<<<< HEAD
            ...
            if block_type == 'x':
                square = plt.Rectangle((y_pos - square_size / 2, x_pos - square_size / 2), 
...
<<<<<<< HEAD
        ...
        if directions and directions != [vx, vy]: # if it bounced
            # print('appending', [end_x, end_y, directions[0], directions[1]])
=======
        end_x, end_y, directions = find_lazor_endpoint(
            lazor_grid, start_x, start_y, vx, vy, x_size_grid, y_size_grid
        )
